...
save_file_path = r"\\smbhome.uscs.susx.ac.uk\jw468\Documents\Course Modules\Year 2\Natural Language Engineering\Lab 8\output5.txt"    # Set this to the location of the file you wish to create/overwrite with the saved output.
