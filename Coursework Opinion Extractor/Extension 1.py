...
save_file_path = r"\\smbhome.uscs.susx.ac.uk\jw468\Documents\Course Modules\Year 2\Natural Language Engineering\Lab 8\output1.txt"    # Set this to the location of the file you wish to create/overwrite with the saved output.
...
with open(save_file_path, "w") as save_file:  # The 'w' says that we want to write to the file
    ...
    for parsed_sentence in load_parsed_dvd_sentences("plot"):
